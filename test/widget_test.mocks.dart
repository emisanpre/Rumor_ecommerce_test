...
// in rumor_ecommerce_test/test/widget_test.dart.
...
import 'package:rumor_ecommerce_test/models/cart_item/cart_item_model.dart'
    as _i7;
import 'package:rumor_ecommerce_test/models/product/product_model.dart' as _i4;
import 'package:rumor_ecommerce_test/models/user/user_model.dart' as _i3;
...
class MockIAuthService extends _i1.Mock implements _i5.IAuthService {
  ...
  @override
  _i6.Future<void> updateUser(_i3.UserModel? user) => (super.noSuchMethod(
        Invocation.method(
          #updateUser,
          [user],
        ),
  ...
  @override
  _i6.Future<void> deleteUserCartItem(_i7.CartItemModel? cartItem) =>
      (super.noSuchMethod(
        Invocation.method(
          #deleteUserCartItem,
          [cartItem],
...
///
/// See the documentation for Mockito's code generation for more information.
class MockIProductService extends _i1.Mock implements _i8.IProductService {
  MockIProductService() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i6.Future<List<_i4.ProductModel>> fetchProducts() => (super.noSuchMethod(
        Invocation.method(
          #fetchProducts,
          [],
        ),
  ...
  @override
  _i6.Future<_i4.ProductModel> fetchProduct(int? id) => (super.noSuchMethod(
        Invocation.method(
          #fetchProduct,
          [id],
        ),
